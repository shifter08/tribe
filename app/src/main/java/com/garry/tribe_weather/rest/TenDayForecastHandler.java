...
package com.garry.tribe_weather.rest;
...
import com.garry.tribe_weather.utils.OWMDataParser;
...
public class TenDayForecastHandler extends AsyncTask<Location, Void, ArrayList<Day>> {
    ...
    private final static String OWM_APIKEY = "bd5e378503939ddaee76f12ad7a97608";
